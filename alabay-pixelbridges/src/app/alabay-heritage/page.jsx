...
import bg2 from "@/assets/AlabayGames/bg2.png";
import overview from "@/assets/AlabayGames/overview.png";
import Abilities from "@/assets/AlabayGames/Abilities.png";
import artifacts from "@/assets/AlabayGames/artifacts.png";
import locationspreview from "@/assets/AlabayGames/locationspreview.png";
    ...
    return (
        <div className="relative h-screen overflow-hidden">
            ...
            <div
                ...
                style={{ backgroundImage: `url(${bg2.src})`, backgroundAttachment: 'fixed' }}
            >
            ...
            >
                <div className="flex justify-between mb-20">
                    <div>
                        <h1 className="text-5xl text-white font-bold mb-2">ALABAY HERITAGE</h1>
                ...
                <div className="md:flex justify-between items-center">
                    <div className="border-2 border-white h-48 rounded-2xl">
                        <Image src={overview} alt="Overview" width={500} height={500} className="object-cover w-full h-full rounded-2xl" />
                    </div>
                    <div className="border-2 border-white h-48 rounded-2xl">
                        <Image src={Abilities} alt="Abilities" width={500} height={500} className="object-cover w-full h-full rounded-2xl" />
                    </div>
                    <div className="border-2 border-white h-48 rounded-2xl">
                        <Image src={artifacts} alt="Artifacts" width={500} height={500} className="object-cover w-full h-full rounded-2xl" />
                    </div>
                    <div className="border-2 border-white h-48 rounded-2xl">
                        <Image src={locationspreview} alt="Locations Preview" width={500} height={500} className="object-cover w-full h-full rounded-2xl" />
                    </div>
                </div>
